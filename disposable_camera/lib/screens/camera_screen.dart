    ...
    return Row(
      children: [
        ...
        IconButton(
          ...
          icon: const Icon(Icons.cameraswitch, color: Colors.white38),
          tooltip: 'Flip camera',
        ),
        IconButton(
...
class _BottomBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        _ExposureCounter(shotsLeft: shotsLeft),
        _ShutterButton(enabled: canShoot, onPressed: onShoot),
        _DarkroomButton(
...
class _ExposureCounter extends StatelessWidget {
  const _ExposureCounter({required this.shotsLeft});
    ...
    return GestureDetector(
      ...
      child: AnimatedOpacity(
        ...
        child: Container(
          ...
          child: const Icon(Icons.camera_alt, color: Color(0xFF2B2410), size: 34),
        ),
      ),
    );
  }
